...
export default function WhatsAppFab() {
  ...
  const label = lang === "en" ? "WhatsApp" : "واتساب";
  ...
  return (
    <a
      ...
      className="flat-fab whatsapp-fab group"
      aria-label={
        lang === "en"
          ? `Chat with Egy Mac on WhatsApp at ${phoneDisplay}`
          : `تواصل مع إيجي ماك عبر واتساب ${phoneDisplay}`
      }
      title={label}
    >
      <WhatsAppIcon />
      <span className="flat-fab-label hidden sm:inline">{label}</span>
    </a>
  );
}
